...
public class Shop : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        c = new char[Shop.instance.ShopItemsList.Count];
    }
    ...
    public void Start()
    {
        ...
        //read shopsettings
        string ss = PlayerPrefs.GetString("ss", "0");
        //adaugat in var temporala din vo din ss
        ...
        for (int i = 0; i < ShopItemsList.Count; i++)
        {
            ...
            if (i == PlayerPrefs.GetInt("posImg", 0))
            {
    ...
    void OnShopItemBtnClicked(int itemIndex)
    {
        ...
        if (buyBtn.transform.GetChild(0).GetComponent<TMP_Text>().text == "Select")
        {
            ...
            buyBtn = ShopScrollView.GetChild(PlayerPrefs.GetInt("posImg",0)).GetChild(2).GetComponent<Button>();
            buyBtn.interactable = true;
            //new inactive nr in list
            PlayerPrefs.SetInt("posImg", itemIndex);//nr_select = itemIndex;
        }
        else
        {
            //buy with coins
            ...
            ShopItemsList[itemIndex].realMoney !=true)
            {
                ...
                c[itemIndex] = '1';
                PlayerPrefs.SetString("ss", new string(c));
